...
import dev.bayan_ibrahim.my_dictionary.data_source.local.data_store.words_list_filter.MDWordsListTrainPreferencesImpl
...
class MDPreferences @Inject constructor(
    ...
    MDWordsListViewPreferences by MDWordsListViewPreferencesImpl(context),
    MDWordsListTrainPreferences by MDWordsListTrainPreferencesImpl(context)
