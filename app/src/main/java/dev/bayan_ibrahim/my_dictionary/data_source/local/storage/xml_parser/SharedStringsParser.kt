...
object SharedStringsParser {
    fun parseSharedStrings(inputStream: InputStream): Result<List<String>> {
        return inputStream.use { inputStream ->
            runCatching {
                ...
                parser.navigateToTag(TAG_SHARED_STRINGS).fold(
                    onFailure = {
                    ...
                    onSuccess = { exist ->
                        ...
                        while (true) {
                            val nextSharedString = parser.parseSharedString().getOrNull() ?: break
    ...
    private fun XmlPullParser.parseSharedString(): Result<String> {
        return runCatching {
            navigateToTag(TAG_SHARED_STRING).fold(
                onFailure = {
                ...
                onSuccess = { exist ->
                    ...
                    navigateToTag(TAG_SHARED_STRING_TEXT).fold(
                        onFailure = {
