...
class MDWordDetailsEditModeRepoImpl(
...
) : MDWordDetailsEditModeRepo, MDContextTagsRepo by MDContextTagsRepoImpl(contextTagDao, wordsCrossContextTagDao) {
    override suspend fun getWord(id: Long): Word? {
        val word = wordWithContextTagsAndRelatedWordsDao.getWordWithContextTagsAndRelatedWordsRelation(id) ?: return null
    ...
    override suspend fun saveNewWord(word: Word): Long {
